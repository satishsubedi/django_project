    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usertype', models.CharField(choices=[('patient', 'patient'), ('doctor', 'doctor'), ('examiner', 'examiner')], max_length=32)),
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now_add=True)),
                ('is_verified', models.BooleanField(default=False, verbose_name='Verfied')),
                ('image', models.ImageField(blank=True, null=True, upload_to='media/images/user/%Y-%m-%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='examiner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ...
                ('is_active', models.BooleanField(default=False)),
                ('speciality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='speciality', to='users.DoctorSpeciality')),
